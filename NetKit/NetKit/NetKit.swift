...
public class NetKitGloble{
    public typealias returnObjectHandel = (json:JSON) -> (JSON?,NSError?)
    public static var addingParameters = [String:AnyObject]()
    public static var addingHTTPHeaderFields = [String:String]()
    public static var willReturnObjectBlock:returnObjectHandel?
    public class func willReturnObjectBlock(handel:returnObjectHandel){
        NetKitGloble.willReturnObjectBlock = handel
    }
}
